	...
	<?php endif;?></a></th>
      ...
      <tr>
        <td style="text-align: left;" valign="top"> Dear <?php echo $data['fname'].' '.$data['lname'];?>, <br>
          Welcome to <?php echo Registry::get("Core")->company;?> To start using <?php echo Registry::get("Core")->company;?> you will need to <a href="<?php echo Registry::get("Core")->site_url;?>/admin">login to your staff panel</a> </td>
      </tr>
      <tr>
