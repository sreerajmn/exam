...
<div style="font-family:Arial, Helvetica, sans-serif; font-size:13px;margin:20px" align="center">
  <table style="background-color:#F4F4F4; border: 2px solid #bbbbb;" border="0" cellpadding="10" cellspacing="5" width="650">
	...
	<?php endif;?></a></th>
      ...
      <tr>
        <td style="text-align: left;" valign="top"> Dear <?php echo $userdata->fname.' '.$userdata->lname;?>, <br>
         It seems that you or someone requested a new password for you. We have generated a new password, as requested: </td>
      </tr>
      <tr>
        <td style="text-align: left;" valign="top"><strong>Password Details:</strong><br>
          <br>
          <table width="100%" border="0" cellpadding="5" cellspacing="2">
            <tr>
              <td width="150" style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">New Password:</td>
              <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;"><?php echo $randpass;?></td>
            </tr>
          </table></td>
      </tr>
      <tr>
        <td style="text-align: left;" valign="top"><em>You can change your password after you sign in.</em></td>
      </tr>
      <tr>
